 ...
 *
 * Description: Magic numbers being separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int alph;
 ...
 *
 * Description: exit code 98 if dthe file cannot be closed.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * @argv: array of pointers fed to the arguments.
 *
